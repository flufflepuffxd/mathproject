...
var q = ["<img src='css/image/Addition/Q2/Q2.png' height='500' width='900' border='5'><br /><br />", 
		...
		var a1 = ["<button class=buttons002 onclick=q1c()><img src='css/image/Addition/Q2/ans1.png' height='400' width='400'  ></button>",
                  "<button class=buttons002 onclick=q2c()><img src='css/image/Addition/Q1/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q3c()><img src='css/image/Addition/Q5/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q4i()><img src='css/image/Addition/Q3/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q5i()><img src='css/image/Addition/Q4/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q6i()><img src='css/image/Subtraction/Q2/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q7i()><img src='css/image/Subtraction/Q1/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q8i()><img src='css/image/Subtraction/Q5/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q9i()><img src='css/image/Subtraction/Q3/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q10i()><img src='css/image/Subtraction/Q4/ans2.png' height='400' width='400' ></button>"];

        var a2 = ["<button class=buttons002 onclick=q1i()><img src='css/image/Addition/Q2/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q2i()><img src='css/image/Addition/Q1/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q3i()><img src='css/image/Addition/Q5/ans2.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q4c()><img src='css/image/Addition/Q3/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q5c()><img src='css/image/Addition/Q4/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q6c()><img src='css/image/Subtraction/Q2/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q7i()><img src='css/image/Subtraction/Q1/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q8i()><img src='css/image/Subtraction/Q5/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q9i()><img src='css/image/Subtraction/Q3/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q10i()><img src='css/image/Subtraction/Q4/ans3.png' height='400' width='400' ></button>"];

        var a3 = ["<button class=buttons002 onclick=q1i()><img src='css/image/Addition/Q2/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q2i()><img src='css/image/Addition/Q1/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q3i()><img src='css/image/Addition/Q5/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q4i()><img src='css/image/Addition/Q3/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q5i()><img src='css/image/Addition/Q4/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q6i()><img src='css/image/Subtraction/Q2/ans3.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q7c()><img src='css/image/Subtraction/Q1/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q8c()><img src='css/image/Subtraction/Q5/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q9i()><img src='css/image/Subtraction/Q3/ans4.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q10i()><img src='css/image/Subtraction/Q4/ans4.png' height='400' width='400' ></button>"];

        var a4 = ["<button class=buttons002 onclick=q1i()><img src='css/image/Addition/Q2/ans4.png' height='400' width='400'  ></button>",
                  "<button class=buttons002 onclick=q2i()><img src='css/image/Addition/Q1/ans4.png' height='400' width='400'  ></button>",
                  "<button class=buttons002 onclick=q3i()><img src='css/image/Addition/Q5/ans4.png' height='400' width='400'  ></button>",
                  "<button class=buttons002 onclick=q4i()><img src='css/image/Addition/Q3/ans4.png' height='400' width='400'  ></button>",
                  "<button class=buttons002 onclick=q5i()><img src='css/image/Addition/Q4/ans4.png' height='400' width='400'  ></button>",
                  "<button class=buttons002 onclick=q6i()><img src='css/image/Subtraction/Q2/ans4.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q7i()><img src='css/image/Subtraction/Q1/ans4.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q8i()><img src='css/image/Subtraction/Q5/ans4.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q9c()><img src='css/image/Subtraction/Q3/ans1.png' height='400' width='400' ></button>",
                  "<button class=buttons002 onclick=q10c()><img src='css/image/Subtraction/Q4/ans1.png' height='400' width='400' ></button>"];
